...
************************************************************************
      ...
      character*20 Pfile(maxTimeBreaks)
...
************************************************************************
      ...
      character*6 Tlseg
      character*3 Tlu
      character*20 LCVfile(maxTimeBreaks)
...
************************************************************************
      ...
      character*6 Tlseg
      character*3 Tlu
      character*20 Lfile(maxTimeBreaks)
...
************************************************************************
     ...
     I                      species,nspecies)
      ...
      character*20 Mfile(maxTimeBreaks)
...
************************************************************************
     ...
     I                      species,nspecies)
      ...
      character*3 Tlu    ! land use
      character*4 Tsp    ! nutrient species
      character*20 Ffile(maxTimeBreaks)
...
************************************************************************
      ...
      character*3 Tlu    ! land use
      character*4 Tsp    ! nutrient species
      character*20 Tfile(maxTimeBreaks)
...
************************************************************************
      ...
      character*3 Tlu    ! land use
      character*4 Tsp    ! nutrient species
      character*20 Ufile(maxTimeBreaks)
