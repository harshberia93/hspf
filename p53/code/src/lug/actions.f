...
************************************************************************
      ...
      character*20 LCVfile(maxTimeBreaks)        ! land cover files
      integer nB
...
************************************************************************
      ...
      character*20 Pfile(maxTimeBreaks)        ! legume file name
      integer nB,nm
...
************************************************************************
      ...
      character*20 Ufile(maxTimeBreaks)   ! monthly uptake files
      integer nB, n, NB2
