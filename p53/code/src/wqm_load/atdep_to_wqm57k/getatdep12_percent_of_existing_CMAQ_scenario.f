...
************************************************************************
     ...
     I                              facwetno3,facdryno3,
     I                              facwetnh3,facdrynh3,
     I                              facwetorn,facwetorp,facwetpo4,
     O                              cellwq)
      implicit none
      include 'inc_atdep.f'
...
******************** get the wetfall data
     ...
     .                year,month,day)
        if (nd.ge.1.and.nd.le.ndays) then
          ...
          wetnh3load(nd) = DNH3narr * cellarea * facwetnh3 ! in kg/day
          wetno3load(nd) = DNO3narr * cellarea * facwetno3 ! in kg/day
        end if
      end do
111   close (dfile)
