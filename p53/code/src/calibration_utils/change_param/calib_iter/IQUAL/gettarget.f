************************************************************************
** subroutine target scenario from ./run/control/calib/IQUAL/calscen/ **
************************************************************************
...
*************** loop over all segments in file, look for active segs
      ...
      do while (dline(:3).ne.'end')       
        ...
        read(dfile,'(a500)',err=996,end=997)dline    ! read next line
        call d2x(dline,i)
      end do
...
995   report(1) = 'data line too long, modify '
      report(2) = fnam
      report(3) = ' or adjust dline in ./pp/src/.../IQUAL/gettarget.f'
      go to 999
