...
************************************************************************
** specific program to read the calibration file and create a         **
**  repeating year for a scenario                                     **
************************************************************************
      implicit none
...
******** get input data
      read*, year,psscen,dataversion,nonCSOfnam,CSOfnam
...
************ loop over all lines and populate variables
     ...
     .                                  Ndum,Tpo4,Torp,Pdum,Ttss
        ...
        if (ny .ne. year) cycle          ! only read the scanrio year
...
************** add this line to lrseg variables
        do ny = y1,y2  ! loop over all years
