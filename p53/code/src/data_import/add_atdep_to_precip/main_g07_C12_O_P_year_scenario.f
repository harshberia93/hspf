...
**                                                                    **
**  modified for a scenario based on the year                         **
**   similarly to the back-casting of dry deposition, the trend in    **
**   wet is used to center the deposition on a particular time        **
************************************************************************
      include 'qstd.inc'
...
************** end declarations, get segment and set dates
      read*,seg,sdate(1),edate(1),scenyear,
     .      CMAQcal,dir2cal,longnamecal
