...
************************************************************************
      subroutine getmondfs(Tseg,lenrseg,rscen,lenrscen,
...
************************** 
     ...
     .       '/'//Tseg(:lenrseg)//'_'//rscen(:lenrscen)//'.txt'
...
************************************************************************
************************************************************************
      subroutine getanndfs(Tseg,lenrseg,rscen,lenrscen,
     I                      ndel,delname,sdate,edate,
...
************************************************************************
************************************************************************
      subroutine getavedfs(Tseg,lenrseg,rscen,lenrscen,
