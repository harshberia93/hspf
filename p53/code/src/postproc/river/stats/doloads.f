...
********  simulated daily, annual, and monthly load
      real simld(1984:2005,12,31)
      real simannld(1984:2005)
      real simmonld(1984:2005,12)
      real load(ndaymax*24)
                    
********  observed annual and monthly loads and confidence intervals
      real obsannld(1984:2005)
      real obsmonld(1984:2005,12)
      real upannCI(1984:2005),loannCI(1984:2005) ! confidence intervals
      real upmonCI(1984:2005,12),lomonCI(1984:2005,12) 
      real tld,tuci,tlci
