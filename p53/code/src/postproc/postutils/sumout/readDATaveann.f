...
************************************************************************
     ...
     O                          ps,sep,atdep,atdepacres)
      ...
      real ps(nloadmax),sep(nloadmax),atdep(nloadmax)
...
************ pointsource
     ...
     .                                acres
          ...
          read(11,1234,err=992) y1,y2,(ps(nl),nl=1,nloads),acres
        end if
...
************ septic
     ...
     .                                acres
          ...
          read(11,1234,err=992) y1,y2,(sep(nl),nl=1,nloads),acres
        end if
...
************ atdep
     ...
     .                                 atdepacres
          ...
          read(11,1234,err=992) y1,y2,(atdep(nl),nl=1,nloads),atdepacres
        end if
