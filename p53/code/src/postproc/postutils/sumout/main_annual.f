...
Clrsegs      real allEOFlrseg(maxrsegs*maxL2R,nloadmax+1,year1:year2) 
      ...
      real allEOFps(nloadmax+1,year1:year2) 
...
Clrsegs      real allEOSlrseg(maxrsegs*maxL2R,nloadmax+1,year1:year2) 
      ...
      real allEOSps(nloadmax+1,year1:year2) 
...
Clrsegs      real allDELlrseg(maxrsegs*maxL2R,nloadmax+1,year1:year2) 
      ...
      real allDELps(nloadmax+1,year1:year2) 
...
Clrseg     .                              + EOFatdep(nload,ny)
                allEOFps(nload,ny) = allEOFps(nload,ny) 
     .                                + EOFps(nload,ny)
...
Clrseg     .                              + EOSatdep(nload,ny)
                allEOSps(nload,ny) = allEOSps(nload,ny)
     .                                + EOSps(nload,ny)
...
Clrseg     .                              + DELatdep(nload,ny)
                allDELps(nload,ny) = allDELps(nload,ny)
     .                                + DELps(nload,ny)
...
************* point source
     ...
     .        'pointsourc.csv'
        ...
        do ny = year1,year2
          write(11,1234,err=951) ny,
     .                   (',',allEOFps(nload,ny),nload=1,nloads)
        end do
        close(11)
...
************* point source
     ...
     .        'pointsourc.csv'
        ...
        do ny = year1,year2
          write(11,1234,err=951) ny,
     .                   (',',allEOSps(nload,ny),nload=1,nloads)
        end do
        close(11)
...
************* point source
     ...
     .        'pointsourc_'//DFmethod//'.csv'
        ...
        do ny = year1,year2
            write(11,1234,err=951) ny,
     .                 (',',allDELps(nload,ny),nload=1,nloads)
        end do
        close(11)
