...
************************************************************************
     ...
     I                         BMPconname,nbcon,
     I                         BmpName,nBmpTypes,
     I                         BmpEff,AdditiveBmp,
C     I                         BmpEff,MaxImplement,AdditiveBmp,
...
C              constrained(nBmp,2,i,l) = constrained(nBmp,1,i,l)
            end do
          end do
        end do
      end if
...
********** disallow negatives and convert from annual to daily
        do l = 1,nlu
          do nb = 1,nbcon
            do j = 1,ndays
              if (dailypounds(j,nb,l).lt.0.0) dailypounds(j,nb,l) = 0.0
